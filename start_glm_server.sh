...
# GLM-4.7-Flash llama-cpp-python Server Launcher
# Starts the GLM-4.7 server with tool calling support
...
nohup python3 -u "$PYTHON_SERVER_DIR/glm_server.py" > "$LOG_FILE" 2>&1 &
SERVER_PID=$!
